...
return ( list ( ht=ht_long_fusion, long_info_details = long_info, singleg =long_total_fusion, temporal.key=temporal.key ))


}

fuse_longout = compute_longi( fusion )
outUP_longout = compute_longi( out[ out$both == "OUTLIER_HIGH" & out$gene %in%  genelist$gene, ] , "gene" )
