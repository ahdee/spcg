...
exon = readRDS( '/data/SUMMARY/EXON_COUNT/exon_counts_correlations.rds')
exon_cor = exon$corr
exon_tpm = exon$data
rm ( exon )
gc()
...
exon_tpm = exon_tpm[ exon_tpm$gene_name %in% as.character ( genelist$gene ),  c ( names ( exon_tpm)[1:12], trueseq.key$RNAseq.id) ]
...
base = melt ( exon_tpm[ exon_tpm$transcript_id == t,  c ( "median", "exon_number", "gene_name", c( "AA3", "AJ10", "Z12", "K2") ) ] 
